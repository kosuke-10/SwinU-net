...
from src.trainer import trainer_synapse, trainer_cellmix

# argparse設定（変更なし）
parser = argparse.ArgumentParser()
parser.add_argument('--root_path', type=str, default='../datasets/Synapse', 
...
parser.add_argument('--cfg', type=str, required=True, 
                    help="path to config file", default='../configs/swin_tiny_patch4_window7_224_lite.yaml')
...
if __name__ == "__main__":
    ...
    elif args.dataset == "CellMix":
        trainer_cellmix(args, net, args.output_dir)
    else:
        raise ValueError(f"Unknown dataset: {args.dataset}. Supported: 'Synapse', 'CellMix'")